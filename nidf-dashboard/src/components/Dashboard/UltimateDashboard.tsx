  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg sm:text-2xl font-bold text-white">Neosperience Intelligent Data Fabric</h1>
                <p className="text-xs sm:text-sm text-blue-200 hidden md:block">L'Open Platform per il Digital Enablement della Tua Azienda</p>
              </div>
              <div className="sm:hidden">
                <h1 className="text-base font-bold text-white">NIDF</h1>
              </div>
            </div>
      ...
      <div className="flex relative">
        {/* Main Content */}
        <div className="flex-1 p-4 sm:p-6 transition-all lg:mr-[44rem]">
          {/* Metrics Grid */}
        ...
        {/* Integrations Panel - Desktop Always Visible */}
        <div className="hidden lg:block fixed right-96 top-20 h-[calc(100vh-5rem)] w-80 bg-black/40 backdrop-blur-xl border-l border-white/10">
          <IntegrationsPanel />
        </div>
