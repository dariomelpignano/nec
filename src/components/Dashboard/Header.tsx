        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold">Neosperience Intelligent Data Fabric</h1>
                <p className="text-sm text-blue-100">L'Open Platform per il Digital Enablement della Tua Azienda</p>
              </div>
            </div>
          </div>
